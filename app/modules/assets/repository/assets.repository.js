...
const assetmodel=require('../model/assets.model');
const _ =require('lodash');
const moment=require('moment');

class assetRepositroy extends baseRepository{
    constructor(){
        super(assetmodel)
    };
    ...
    async getAll(req,res) {
            try {
              ...
              let aggregate = assetmodel.aggregate([
                { $match: conditions },
                {
                  $lookup:{
                    from:"users",
              ...
              let allDatas = await assetmodel.aggregatePaginate(aggregate, options);
    ...
    async getAssetDetailsById(filter){
...
module.exports=new assetRepositroy();
