  ...
  if (dtBlogTable.length) {
    ...
    const table = dtBlogTable
      ...
      .DataTable({
        ...
        serverSide: true,
        ajax: {
          url: `${window.location.protocol}//${window.location.host}/admin/debt/getall`,
          method: "POST",
          data: function (d) {
            ...
            if (selectedValue === "creditCard" || selectedValue === "mortage") {
        ...
        language: {
          ...
          search: "Search",
          searchPlaceholder: "Search Debtt by name ",
          processing: "Loading...",
    ...
    $(document).on("click", ".view-asset", function () {
      ...
      window.location.href = `/admin/debt/getdetails/${assetId}`;
    });
    ...
    $("#confirmStatusChange").on("click", function () {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: `/admin/debt/changestatus/${subsId}`,
            method: "PUT",
    ...
    $(document).on("click", ".edit-asset", async function () {
      ...
      try {
        ...
        const response = await fetch(`/admin/debt/details/${assetId}`);
